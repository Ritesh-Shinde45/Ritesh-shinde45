...
- Conducted network scanning and enumeration using Nmap on a local test network  
- Identified open ports, running services, and potential security risks  
- Analyzed system exposure and basic vulnerabilities  
...
- Gaining hands-on experience with AWS and cloud networking  
- Building security-focused projects  
- Preparing for AWS and Security+ certifications  

---

## Contact
- 💼 LinkedIn: [Ritesh Shinde](https://linkedin.com/in/ritesh--shinde)
- 📧 Email: [riteshshinde472@gmail.com](mailto:riteshshinde472@gmail.com)
---
